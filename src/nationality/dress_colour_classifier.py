"""Dress colour classifier for nationality routing."""
...
class DressColourClassifier(KerasModelMixin):
    """Custom CNN classifier for dominant dress colour."""
